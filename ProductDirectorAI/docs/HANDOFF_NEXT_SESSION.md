...
| **V5** | **进行中**：V5-01 摄取、V5-02 切镜（10/10 合成夹具 F1=1.0）、V5-03 观察/推断分离、V5-04 计划映射（误差 ≤1 帧/镜头、≤2 帧总）、**V5-05 参考重演双栏工作台已上线**（线上冒烟 10/10，见 [V505 报告](reports/V505_REENACTMENT_UI_2026-09-13.md)）；剩 V5-06 真实重演（3 条含 1 条 V4 互动镜头）+ 10 条许可参考片人工标注夹具 + V5_ACCEPTANCE |
| 后端测试 | **383/383**（云端，2026-09-13，V5-05 之后全量） |
| 前端 | build ✓ + Sites **4/4**（云端，2026-09-13） |
| 代码 | GitHub `main` = V5-05 提交，云端工作区干净 |
| 云端 | api / web / postgresql / comfy-h3 四个 systemd 服务均 active |

明确没有完成的：V3/V4 阶段门（负责人人工复核两份 ACCEPTANCE 草稿）、V4 尾巴（真人感人物层/双人动作/修订流程/浏览器走查）、V5-06 真实重演与 V5_ACCEPTANCE、V6。不能对外说"V3 完成"、"V5 完成"或"V6 完成"。
