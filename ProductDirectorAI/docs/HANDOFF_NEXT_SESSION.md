...
| **V6** | **已开工**：**V6-01 Platform Profile 与后期模板完成**（六组字段的版本化合同、六个种子 Profile、BLOCKING/WARNING 校验、成片兼容性、后期模板与配音适配策略；硬限制/规则/账号能力全部如实标注未核验或未配置；线上冒烟 16/16，[V6-01 报告](reports/V601_PLATFORM_PROFILE_2026-09-13.md)）；**V6-02 本地化与字幕完成**（es-MX 文案事实/生成分离 + 违规宣传扫描、SRT/VTT 与时间轴校验、**真实语音对齐**（沉默切分，语音段不足会回退并说明）、真实离线西语配音与试听、授权配音上传、配音过长显式报告适配策略、人工修订 revision 链；libass 与软字幕在真实成片上验证；线上 21/21，[V6-02 报告](reports/V602_LOCALIZATION_TTS_2026-09-13.md)）；**V6-03 混音与编码完成**（BGM 许可闸门、旁白优先 ducking（分支级实测语音段压低 8.6 dB）、响度实测 −15.5 LUFS / −1.0 dBTP 与最终 MP4 复测、音轨开关真的改变输出、时长适配三策略（接触镜头绝不动）、成片 + 无字幕 Master + 封面 + lineage、9:16→1:1 letterbox 不拉伸；线上 21/21，[V6-03 报告](reports/V603_AUDIO_POST_2026-09-13.md)）；剩 V6-04…16（Batch 矩阵与失败恢复、发布包、成本账本、Automation/Webhook、总控台、四个平台连接器、权限与上线手册） |
| 后端测试 | **452/452**（云端，2026-09-13，V6-03 之后全量） |
