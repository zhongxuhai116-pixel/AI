...
| **V6** | **已开工**：**V6-01 Platform Profile 与后期模板完成**（六组字段的版本化合同、六个种子 Profile、BLOCKING/WARNING 校验、成片兼容性、后期模板与配音适配策略；硬限制/规则/账号能力全部如实标注未核验或未配置；线上冒烟 16/16，[V6-01 报告](reports/V601_PLATFORM_PROFILE_2026-09-13.md)）；**V6-02 本地化与字幕完成**（es-MX 文案事实/生成分离 + 违规宣传扫描、SRT/VTT 与时间轴校验、**真实语音对齐**（沉默切分，语音段不足会回退并说明）、真实离线西语配音与试听、授权配音上传、配音过长显式报告适配策略、人工修订 revision 链；libass 与软字幕在真实成片上验证；线上 21/21，[V6-02 报告](reports/V602_LOCALIZATION_TTS_2026-09-13.md)）；剩 V6-03…16（BGM/ducking/响度与时长适配执行、Batch、发布包、成本账本、Automation/Webhook、总控台、四个平台连接器、权限与上线手册） |
| 后端测试 | **430/430**（云端，2026-09-13，V6-02 之后全量） |
| 前端 | build ✓ + Sites **4/4**（云端，2026-09-13） |
| 代码 | GitHub `main` = V5-06 提交，云端工作区干净 |
| 云端 | api / web / postgresql / comfy-h3 四个 systemd 服务均 active |

明确没有完成的：V3/V4/V5 阶段门（负责人人工复核三份 ACCEPTANCE 草稿）、V4 尾巴（真人感人物层/双人动作/修订流程/浏览器走查）、V5 的 10 条许可参考素材人工标注、V6-03…16。不能对外说"V3 完成"、"V5 完成"或"V6 完成"。
