...
| V4-01…03 | 锚点/人物/动作版本；Proxy、IK/时序/碰撞；接触距离≤2cm或更严格锚点半径、偏差≤2帧、穿透≤1cm且不持续超过2帧 | V4-01 合同与 V4-02/03 合同+校验引擎已实现（2026-09-13）：锚点/锚点集/人物/动作模板、交互计划版本化与失效联动、确定性 Proxy 校验（接触/穿透/时序阈值按主规划）、数据版预演时间线，线上已部署并冒烟。**渲染侧未做**（Blender 人体 Proxy、IK/碰撞几何、真实按按钮与击打几何验证）。注意：V3 阶段门仍待负责人人工复核，V4 工程按项目先例先行推进，不宣布 V3 PASS |
