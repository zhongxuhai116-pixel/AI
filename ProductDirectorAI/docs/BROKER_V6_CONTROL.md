...
| V5-01…03 | 授权参考上传/代理时间戳、切镜与人工修改、多模态证据及置信度 | V5-01 已实现（2026-09-13）：本地上传 + URL 直连（仅公网 http(s) 视频、防 SSRF、上限/类型约束）、ffprobe/ffmpeg 代理、source_to_proxy_map 时间戳映射；真实上传冒烟通过。V5-02 切镜与 V5-03 多模态分析未开工 |
