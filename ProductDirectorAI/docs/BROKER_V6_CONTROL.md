...
| V4-04…07 | 真人感人物层及来源、遮挡与可见产品保真、修订UI；走近/按按钮/击打/收回/庆祝/双人轮流，真实成片两轮人工审核 | V4-04 能力校验与 V4-05 真实人物遮挡合成已闭环（2026-09-13）：人物素材引用校验、能力报告如实 NOT_CONFIGURED（生成路线未配置）；Proxy 人物层合成 72 帧（豁免 455 万像素、可见区域保真、双产品零误报），证据见 V404 报告。**未做**：真人感人物层（生成工作流/授权素材真实素材）、击打与双人动作、修订 UI、真实成片两轮人工审核。Proxy 通过不等同真人成片通过 |
