...
| V5-01…03 | 授权参考上传/代理时间戳、切镜与人工修改、多模态证据及置信度 | V5-01 摄取与 V5-02 切镜已实现（2026-09-13）：上传/URL 约束/代理/时间戳映射；ffmpeg scene SAD 硬切 + 渐变聚簇 + 人工标注对照指标（10/10 合成夹具 F1=1.0 过 0.90 门，真实素材人工标注夹具待补）；分析修订/冻结。V5-03 多模态分析未开工 |
