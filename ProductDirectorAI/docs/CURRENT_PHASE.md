...
- 状态：PARTIAL；新云节点 V1 基础设施、GPU 渲染、通用 GLB 端到端链路和 DirectorPlan 相机语义已 PASS，完整产品合同、可靠任务、鉴权、1080×1920 和用户真实素材仍待验收
...
- 通用产品图片/GLB 上传与素材库
- 模板三镜头 DirectorPlan、镜头名称/机位/焦距/时长编辑、保存、确认和每作业冻结快照；GLB 渲染器已编译相机字段，图片预演仍未应用分镜语义
