...
- 未完成（如实记录）：V3/V4/V5 负责人人工复核（三份 ACCEPTANCE 草稿）；V4 尾巴（真人感人物层、双人动作、修订流程、浏览器走查）；V5 的 10 条许可参考素材人工标注夹具；V6-16（权限、全量回归、运行/部署/备份手册、OpenAPI、示例包、V6_ACCEPTANCE）；四个平台连接器的真实发布验证（无授权 → BLOCKED）。
