...
- 未完成（如实记录）：V3/V4/V5 负责人人工复核（三份 ACCEPTANCE 草稿）；V4 尾巴（真人感人物层、双人动作、修订流程、浏览器走查）；V5 的 10 条许可参考素材人工标注夹具；V6-02…16（es-MX 文案/字幕/TTS、BGM/ducking/响度、Batch、发布包、成本账本、Automation/Webhook、总控台、四个平台连接器、权限与上线手册）。
